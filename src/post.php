...
<div class="matecho-article-wrapper mx-auto px-0 md:px-2 box-border max-w-840px">
    <?php if (!$this->hidden) { ?>
        ...
        <div class="w-full px-4 box-border">
            ...
            <div class="mt-2">
                ...
                <?php } ?>
                <div class="py-4 matecho-comment-form matecho-comment-form__main w-full box-border relative <?php echo $this->allowComment
                  ? ""
                  : "matecho-comment-form__lock"; ?>"
  ...
  $this->options->commentsRequireMail
                                ...
                                <mdui-text-field class="w-full sm:w-1/3 pt-2 sm:pt-0 sm:pl-1" label="网址" variant="outlined"
                                    type="url" name="url" value="<?php $this->remember(
                                      "url"
                                    ); ?>" <?php if (
  $this->options->commentsRequireURL
    ...
    <?php } else { ?>
        ...
        <form class="max-w-420px pa-2 box-border md:pa-0 w-full mx-auto relative" id="matecho-password-form" method="post"
            action="<?php echo $this->security->getTokenUrl(
              $this->permalink
            ); ?>" data-pjax-state>
            <div class="matecho-form-loading-mask">
                <mdui-circular-progress></mdui-circular-progress>
